...
class Bidang extends CI_Controller {
    ...
    {
        $bidang = $this->getDataBidang($tabel);
        $data['bidangPivot'] = $bidang['pivot'];
        $data['bidangKomoditas'] = $bidang['komoditas'];
        $data['bidangBulan'] = $bidang['bulan'];
        $data['bidangTahun'] = $bidang['tahun'];
        $data['tabel'] = $tabel;
    ...
    public function export() {
        ...
        foreach ($bidangPivot as $kec => $row) {
            $col = 0;
